...
| Reviewer model unavailable | Your Codex account cannot use the default model | The skill auto-tries fallback models (gpt-5.5 -> o3 -> gpt-4.1 -> gpt-4o). If all fail, run `codex login` to check auth, or specify a model explicitly: `reviewer:<model-you-have>`. |
